...
# README
#####################################################################
# Provides the Qwen Honed chat template.
#####################################################################

#####################################################################
# Metadata
#####################################################################
export MOD_NAME="qwen-honed-chat-template"
export MOD_DESCRIPTION="Provides the Qwen Honed chat template."
...
log "Cloning Qwen Honed git repo..."
log_cmd git clone --depth 1 https://github.com/littlecedar/qwen3-honed-chat-templates.git
