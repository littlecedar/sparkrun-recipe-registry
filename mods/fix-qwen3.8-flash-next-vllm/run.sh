...
# README
#####################################################################
# vLLM fixes for Qwen3.8-Flash-Next
# Uses the `apply-ple-patch.py` script from
# https://github.com/humanrouter/qwen38-flash-next-2x-spark
#####################################################################

#####################################################################
# Metadata
#####################################################################
MOD_NAME="fix-qwen3.8-flash-next-vllm"
MOD_DESCRIPTION="Patches vLLM to work with Qwen3.8-Flash-Next"
...
log_cmd python3 apply-ple-patch.py
