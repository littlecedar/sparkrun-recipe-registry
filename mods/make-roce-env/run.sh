...
# README
#####################################################################
# Creates a .env file that can be sourced or imported at runtime to
# configure RoCE for NCCL, GLOO, et al.
# Tasks:
...
log_cmd uv pip install netifaces jinja2
log_cmd python3 make-roce-env.py
log_cmd mv -vf .env.roce "${CACHEDIR}"/.env.roce
